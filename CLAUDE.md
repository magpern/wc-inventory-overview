...
| M4 | Receipt Engine | 📋 Plan approved — implementation not started | 1.21.0 | [docs/milestones/m4-implementation-plan.md](docs/milestones/m4-implementation-plan.md) | Plan frozen (READY FOR IMPLEMENTATION verdict); Goods Receipt as stock mutator, Quick Receive; schema v8 |
