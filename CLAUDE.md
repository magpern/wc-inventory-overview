...
is Level A frozen and CI-green on `feature/m25-bulk-draft-po-creation`
(development version `1.42.0`, unreleased) — see
`docs/checklists/m25-release-readiness.md`. All nine foundational
