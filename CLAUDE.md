...
issues found.
**M21 (Position-Aware Reorder Signal) is complete, frozen (Level A
completion review), and development-version-bumped to `1.38.0`, but not
merged, tagged, or released** — `main` remains at `v1.37.0`; see
`docs/checklists/m21-release-readiness.md`. M21 is the first functional
milestone since the M18–M20 refactor program completed: a new
