...
**Canonical published baseline:** `main` / tag **`v1.42.0`**
([`docs/GITHUB_RELEASE_NOTES_1.42.0.md`](docs/GITHUB_RELEASE_NOTES_1.42.0.md);
M24 freeze: [`docs/checklists/m24-release-readiness.md`](docs/checklists/m24-release-readiness.md);
M25 freeze: [`docs/checklists/m25-release-readiness.md`](docs/checklists/m25-release-readiness.md);
combined train review: [`docs/checklists/feature-train-m24-m25-release-readiness.md`](docs/checklists/feature-train-m24-m25-release-readiness.md)).
...
released as v1.40.0, and the bundled M24–M25 Replenishment Planning &
Bulk Draft PO Creation feature train released as v1.42.0.
...
were bundled and released as v1.42.0**.
...
## Platform status: M0–M25 published (v1.42.0); M26 frozen unreleased (1.43.0)

**Current published baseline: plugin 1.42.0, `DB_VERSION` 11.** All nine foundational
...
as `v1.42.0`. **M26 (Apply Replenishment Defaults to Variations) is Level A
frozen at development version `1.43.0` / `DB_VERSION` 11 — unreleased.**
**ROADMAP COMPLETE AFTER M26** — no M27 is scheduled; former M27 work remains
unnumbered evidence-gated backlog only. The Admin
...
`1.41.0` (M24 alone) was never tagged or published. M26 has not started.
