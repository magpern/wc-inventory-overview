...
**Canonical published baseline:** `main` / tag **`v1.38.0`**
([`docs/GITHUB_RELEASE_NOTES_1.38.0.md`](docs/GITHUB_RELEASE_NOTES_1.38.0.md);
M21 freeze: [`docs/checklists/m21-release-readiness.md`](docs/checklists/m21-release-readiness.md)).
...
and M21 (Position-Aware Reorder Signal) released as standalone v1.38.0.
...
standalone v1.38.0**. See milestone plans and readiness checklists in
[`docs/milestones/`](docs/milestones/) and
[`docs/checklists/`](docs/checklists/) for complete per-milestone detail.

## Platform status: M0–M21 published (v1.38.0)

**Current baseline: plugin 1.38.0, `DB_VERSION` 11.** All nine foundational
...
released standalone, is **tagged and published** as `v1.38.0`. The Admin
...
dedicated controller classes. M21 is the first functional milestone
delivered since that program completed.
