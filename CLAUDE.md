...
**Release note:** v1.25.0 (M8) is tagged and published — see `docs/GITHUB_RELEASE_NOTES_1.25.0.md`. v1.26.0 (M9) implementation is complete on branch `feature/m9-supplier-observed-lead-time`, awaiting independent audit acceptance before it is tagged and published — see `docs/GITHUB_RELEASE_NOTES_1.26.0.md`. All prior milestone releases (M0–M7, tags `v1.17.3`–`v1.24.0`) are likewise tagged and published; see their respective `docs/GITHUB_RELEASE_NOTES_*.md`.
