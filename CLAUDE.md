...
## Platform status: M0–M26 published (v1.43.0) — ROADMAP COMPLETE AFTER M26

**Current published baseline: plugin 1.43.0, `DB_VERSION` 11.** All nine foundational
...
and published as `v1.43.0`.** **ROADMAP COMPLETE AFTER M26** — no M27 is
scheduled; former M27 work remains unnumbered evidence-gated backlog only.
The Admin
